...
def _openai_apis():
    sync_apis = (
        ...
        ("openai.resources.beta.threads.messages", "Files", "retrieve", TraceType.MESSAGE, "openai_message_file_retrieve"),
        ("openai.resources.beta.threads.messages", "Files", "list", TraceType.MESSAGE, "openai_message_file_list"),
        ...
        ("openai.resources.beta.threads.runs", "Steps", "retrieve", TraceType.RUN, "openai_step_retrieve"),
        ("openai.resources.beta.threads.runs", "Steps", "list", TraceType.RUN, "openai_step_update"),
    )
    async_apis = (
