...
def _openai_apis():
    sync_apis = (
        ...
        ("openai.resources.beta.threads", "Threads", "create_and_run", TraceType.THREAD, "openai_thread_create_and_run"),
        ("openai.resources.beta.threads", "Threads", "create_and_run_stream", TraceType.THREAD, "openai_thread_create_and_run_stream"),
        ("openai.resources.beta.threads.messages", "Messages", "create", TraceType.MESSAGE, "openai_message_create"),
        ("openai.resources.beta.threads.messages", "Messages", "retrieve", TraceType.MESSAGE, "openai_message_retrieve"),
        ...
        ("openai.resources.beta.threads.runs", "Runs", "create_and_stream", TraceType.RUN, "openai_run_create_and_stream"),
        ...
        ("openai.resources.beta.threads.runs", "Runs", "submit_tool_outputs", TraceType.RUN, "openai_run_submit_tool_outputs"),
        ("openai.resources.beta.threads.runs", "Runs", "submit_tool_outputs_and_poll", TraceType.RUN, "openai_run_submit_tool_outputs_and_poll"),
        ("openai.resources.beta.threads.runs", "Runs", "submit_tool_outputs_stream", TraceType.RUN, "openai_run_submit_tool_outputs_stream"),
        ...
        ("openai.resources.beta.vector_stores", "FileBatches", "create", TraceType.VECTOR_STORE, "openai_file_batch_create"),
        ("openai.resources.beta.vector_stores", "FileBatches", "retrieve", TraceType.VECTOR_STORE, "openai_file_batch_retrieve"),
        ("openai.resources.beta.vector_stores", "FileBatches", "cancel", TraceType.VECTOR_STORE, "openai_file_batch_cancel"),
        ("openai.resources.beta.vector_stores", "FileBatches", "create_and_poll", TraceType.VECTOR_STORE, "openai_file_batch_create_and_poll"),
        ("openai.resources.beta.vector_stores", "FileBatches", "list_files", TraceType.VECTOR_STORE, "openai_file_batch_list_files"),
        ("openai.resources.beta.vector_stores", "FileBatches", "poll", TraceType.VECTOR_STORE, "openai_file_batch_poll"),
        ("openai.resources.beta.vector_stores", "FileBatches", "upload_and_poll", TraceType.VECTOR_STORE, "openai_file_batch_upload_and_poll"),
        ...
        ("openai.resources.beta.vector_stores", "Files", "create_and_poll", TraceType.VECTOR_STORE, "openai_file_create_and_poll"),
        ...
        ("openai.resources.beta.vector_stores", "Files", "upload_and_poll", TraceType.VECTOR_STORE, "openai_file_upload_and_poll"),
        ("openai.resources.beta.vector_stores", "VectorStores", "create", TraceType.VECTOR_STORE, "openai_vector_store_create"),
        ("openai.resources.beta.vector_stores", "VectorStores", "retrieve", TraceType.VECTOR_STORE, "openai_vector_store_retrieve"),
        ("openai.resources.beta.vector_stores", "VectorStores", "update", TraceType.VECTOR_STORE, "openai_vector_store_update"),
        ("openai.resources.beta.vector_stores", "VectorStores", "list", TraceType.VECTOR_STORE, "openai_vector_store_list"),
        ("openai.resources.beta.vector_stores", "VectorStores", "delete", TraceType.VECTOR_STORE, "openai_vector_store_delete"),
    )
    async_apis = (
        ...
        ("openai.resources", "AsyncFiles", "list", TraceType.ASSISTANT, "openai_file_list_async"),
        ...
        ("openai.resources", "AsyncFiles", "wait_for_processing", TraceType.FILE, "openai_file_wait_for_processing_async"),
        ("openai.resources.beta.assistants", "AsyncAssistants", "create", TraceType.ASSISTANT, "openai_assistant_create_async"),
        ("openai.resources.beta.assistants", "AsyncAssistants", "retrieve", TraceType.ASSISTANT, "openai_assistant_retrieve_async"),
        ("openai.resources.beta.assistants", "AsyncAssistants", "update", TraceType.ASSISTANT, "openai_assistant_update_async"),
        ("openai.resources.beta.assistants", "AsyncAssistants", "list", TraceType.ASSISTANT, "openai_assistant_list_async"),
        ("openai.resources.beta.assistants", "AsyncAssistants", "delete", TraceType.ASSISTANT, "openai_assistant_delete_async"),
        ...
        ("openai.resources.beta.threads", "AsyncThreads", "create_and_run", TraceType.THREAD, "openai_thread_create_and_run_async"),
        ("openai.resources.beta.threads", "AsyncThreads", "create_and_run_stream", TraceType.THREAD, "openai_thread_create_and_run_stream_async"),
        ("openai.resources.beta.threads.messages", "AsyncMessages", "create", TraceType.MESSAGE, "openai_message_create_async"),
        ("openai.resources.beta.threads.messages", "AsyncMessages", "retrieve", TraceType.MESSAGE, "openai_message_retrieve_async"),
        ("openai.resources.beta.threads.messages", "AsyncMessages", "update", TraceType.MESSAGE, "openai_message_update_async"),
        ("openai.resources.beta.threads.messages", "AsyncMessages", "list", TraceType.MESSAGE, "openai_message_list_async"), 
        ...
        ("openai.resources.beta.threads.runs", "AsyncRuns", "list", TraceType.RUN, "openai_run_list_async"),
        ("openai.resources.beta.threads.runs", "AsyncRuns", "cancel", TraceType.RUN, "openai_run_cancel_async"),
        ("openai.resources.beta.threads.runs", "AsyncRuns", "create_and_poll", TraceType.RUN, "openai_run_create_and_poll_async"),        
        ("openai.resources.beta.threads.runs", "AsyncRuns", "create_and_stream", TraceType.RUN, "openai_run_create_and_stream_async"),
        ("openai.resources.beta.threads.runs", "AsyncRuns", "poll", TraceType.RUN, "openai_run_poll_async"),        
        ("openai.resources.beta.threads.runs", "AsyncRuns", "stream", TraceType.RUN, "openai_run_stream_async"),
        ("openai.resources.beta.threads.runs", "AsyncRuns", "submit_tool_outputs", TraceType.RUN, "openai_run_submit_tool_outputs_async"),
        ("openai.resources.beta.threads.runs", "AsyncRuns", "submit_tool_outputs_and_poll", TraceType.RUN, "openai_run_submit_tool_outputs_and_poll_async"),
        ("openai.resources.beta.threads.runs", "AsyncRuns", "submit_tool_outputs_stream", TraceType.RUN, "openai_run_submit_tool_outputs_stream_async"),
        ("openai.resources.beta.threads.runs", "AsyncSteps", "retrieve", TraceType.RUN, "openai_run_step_retrieve_async"),
        ("openai.resources.beta.threads.runs", "AsyncSteps", "list", TraceType.RUN, "openai_run_steps_list_async"),
        ("openai.resources.beta.vector_stores", "AsyncFileBatches", "create", TraceType.VECTOR_STORE, "openai_file_batch_create_async"),
        ("openai.resources.beta.vector_stores", "AsyncFileBatches", "retrieve", TraceType.VECTOR_STORE, "openai_file_batch_retrieve_async"),
        ("openai.resources.beta.vector_stores", "AsyncFileBatches", "cancel", TraceType.VECTOR_STORE, "openai_file_batch_cancel_async"),
        ("openai.resources.beta.vector_stores", "AsyncFileBatches", "create_and_poll", TraceType.VECTOR_STORE, "openai_file_batch_create_and_poll_async"),
        ("openai.resources.beta.vector_stores", "AsyncFileBatches", "list_files", TraceType.VECTOR_STORE, "openai_file_batch_list_files_async"),
        ("openai.resources.beta.vector_stores", "AsyncFileBatches", "poll", TraceType.VECTOR_STORE, "openai_file_batch_poll_async"),
        ("openai.resources.beta.vector_stores", "AsyncFileBatches", "upload_and_poll", TraceType.VECTOR_STORE, "openai_file_batch_upload_and_poll_async"),
        ("openai.resources.beta.vector_stores", "AsyncFiles", "create", TraceType.VECTOR_STORE, "openai_file_create_async"),
        ("openai.resources.beta.vector_stores", "AsyncFiles", "retrieve", TraceType.VECTOR_STORE, "openai_file_retrieve_async"),
        ("openai.resources.beta.vector_stores", "AsyncFiles", "list", TraceType.VECTOR_STORE, "openai_file_list_async"),
        ("openai.resources.beta.vector_stores", "AsyncFiles", "delete", TraceType.VECTOR_STORE, "openai_file_delete_async"),
        ("openai.resources.beta.vector_stores", "AsyncFiles", "create_and_poll", TraceType.VECTOR_STORE, "openai_file_create_and_poll_async"),
        ("openai.resources.beta.vector_stores", "AsyncFiles", "poll", TraceType.VECTOR_STORE, "openai_file_poll_async"),
        ("openai.resources.beta.vector_stores", "AsyncFiles", "upload", TraceType.VECTOR_STORE, "openai_file_upload_async"),
        ("openai.resources.beta.vector_stores", "AsyncFiles", "upload_and_poll", TraceType.VECTOR_STORE, "openai_file_upload_and_poll_async"),        
        ("openai.resources.beta.vector_stores", "AsyncVectorStores", "create", TraceType.VECTOR_STORE, "openai_vector_store_create_async"),
        ("openai.resources.beta.vector_stores", "AsyncVectorStores", "retrieve", TraceType.VECTOR_STORE, "openai_vector_store_retrieve_async"),
        ("openai.resources.beta.vector_stores", "AsyncVectorStores", "update", TraceType.VECTOR_STORE, "openai_vector_store_update_async"),
        ("openai.resources.beta.vector_stores", "AsyncVectorStores", "list", TraceType.VECTOR_STORE, "openai_vector_store_list_async"),
        ("openai.resources.beta.vector_stores", "AsyncVectorStores", "delete", TraceType.VECTOR_STORE, "openai_vector_store_delete_async"),
    )
    return sync_apis, async_apis
