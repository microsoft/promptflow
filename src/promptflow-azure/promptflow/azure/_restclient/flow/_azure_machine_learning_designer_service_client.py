...
class AzureMachineLearningDesignerServiceClient(object):    # pylint: disable=too-many-instance-attributes
    ...
    :type base_url: str
    :param api_version: Api Version. Possible values are "1.0.0" or None. Default value is "1.0.0".
