...
from promptflow._utils.flow_utils import dump_flow_dag_to_existing_path, load_flow_dag, resolve_flow_path
    ...
    def _try_build_local_code(self) -> Optional[Code]:
        ...
        with super()._try_build_local_code() as code:
            ...
            if isinstance(code, Code):
                ...
                if dag_updated:
                    dump_flow_dag_to_existing_path(flow_dag, flow_dir)
            try:
                yield code
            finally:
                if dag_updated:
                    dump_flow_dag_to_existing_path(original_flow_dag, flow_dir)
