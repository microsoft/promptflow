...
class TestRunAPIs:
    ...
    def test_get_not_exist_run(self, pfs_op: PFSOperations) -> None:
        ...
        with check_telemetry(activity_name="pf.runs.get", completion_status="Failure"):
