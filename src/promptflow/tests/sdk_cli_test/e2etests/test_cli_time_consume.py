...
class TestCliTimeConsume:
    def test_pf_run_create(self, time_limit=6) -> None:
    ...
    def test_pf_run_update(self, time_limit=1) -> None:
    ...
    def test_pf_flow_test(self, time_limit=1):
    ...
    def test_pf_flow_build(self, time_limit=5):
    ...
    def test_pf_connection_create(self, time_limit=1):
