...
def my_list_func(prefix: str, size: int = 10) -> List[Dict[str, Union[str, int, float, list, Dict]]]:
...
input_text_dynamic_list_setting = DynamicList(function=my_list_func, input_mapping={"invalid_func_input": "invalid_tool_input"})
...
input_settings = {
    ...
    "invalid_tool_input": InputSetting(
