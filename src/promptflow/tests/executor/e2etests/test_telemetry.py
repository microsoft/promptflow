...
class TestExecutorTelemetry:
    def test_executor_openai_telemetry(self, dev_connections):
        ...
        by mocking openai.resources.chat.Completions.create method. The mock method will
        return a generator that yields a namedtuple with a json string of the headers passed
        to the method.
        """

        with patch("openai.resources.chat.Completions.create", new=mock_stream_chat):
