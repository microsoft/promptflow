...
@pytest.mark.e2etest
def test_cosmosdb_create_delete():
    span = Span(
        ...
        attributes={
            ...
            "line_run_id": "8e27a848-476f-42dc-9616-bb7f1054b897",
            "session_id": "8e27a848-476f-42dc-9616-bb7f1054b897",
    ...
    read_span = Span.from_cosmosdb("8e27a848-476f-42dc-9616-bb7f1054b897", "8e27a848-476f-42dc-9616-bb7f1054b897", "96aede12-2f73-41cb-b983-6d11a904839b", "promptflow", "promptflow-canary-dev")
    assert read_span.to_dict() == span.to_dict()
