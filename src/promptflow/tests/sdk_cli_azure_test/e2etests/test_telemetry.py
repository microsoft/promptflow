...
class TestTelemetry:
    ...
    def test_custom_event(self, pf):
        ...
        with (patch.object(PromptFlowSDKExporter, "_log_to_envelope") as mock_logger, patch("promptflow._sdk._telemetry.telemetry.get_telemetry_logger", side_effect=get_telemetry_logger)):
