...
class TestRun:
    ...
    def test_flow_id(self):
        ...
        # run with dict inputs
        session_id1 = get_flow_linage_id(flow_path)
        session_id2 = get_flow_linage_id(flow_path)
        ...
        with TemporaryDirectory() as tmp_dir:
            ...
            session_id3 = get_flow_linage_id(f"{tmp_dir}/flow_with_dict_input")

            session_id4 = get_flow_linage_id(f"{tmp_dir}/flow_with_dict_input")
