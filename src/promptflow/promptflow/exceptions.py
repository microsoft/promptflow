...
class PromptflowException(Exception):
    ...
    def to_dict(self, *, include_debug_info=False):
        ...
        result = {
            ...
            "referenceCode": self.target.value if self.target else None,
        }
...
class ToolExecutionError(UserErrorException):
    ...
    def __init__(self, *, node_name: str):
        ...
        super().__init__(target=ErrorTarget.TOOL)
    ...
    def tool_traceback(self):
        ...
        if exc and exc.__traceback__ is not None:
            ...
            if tb is not None:
                ...
                if self._node_name:
                    formatted_tb = formatted_tb.replace('File "<string>"', f'In "{self._node_name}"')
    ...
    def additional_info(self):
        ...
        return {
            "ToolExecutionErrorDetails": info,
        }
...
class AzureStorageOperationError(SystemErrorException):
    ...
    def __init__(self, message: str, target: ErrorTarget):
...
class ConnectionTypeUnresolved(ValidationException):
    pass
