...
class CustomStrongTypeConnection(_Connection):
    ...
    def _get_custom_keys(cls, data: Dict):
        ...
        try:
            ...
            raise ValueErrorException(
                message=f"Can't find module {m} in current environment. "
                f"Please check the module is correctly configured."
            )
        except AttributeError:
            raise ValueErrorException(
                message=f"Can't find class {custom_cls} in module {m}. "
