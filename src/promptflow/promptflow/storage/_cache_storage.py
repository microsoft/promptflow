...
class AbstractCacheStorage:
    """The abstract class for cache storage, it would be used for storing the caches of each node.

    TODO: Add the implementation of cache storage if there are some requirements.
    """
