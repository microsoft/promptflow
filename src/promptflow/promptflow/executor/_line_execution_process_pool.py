...
def get_available_max_worker_count():
    ...
    # In order to support this flow with two degrees of parallelism, that's equal to about 70%
    # So the available memory is about 30% of the total memory
    available_max_worker_count = math.floor(available_memory * 0.3 / process_memory)
