...
from promptflow.exceptions import PromptflowException, UserErrorException, ValidationException
...
class FlowServiceCaller(RequestTelemetryMixin):
    ...
    def _set_headers_with_user_aml_token(self, headers):
        # NOTE: this copied from https://github.com/Azure/azure-sdk-for-python/blob/05f1438ad0a5eb536e5c49d8d9d44b798445044a/sdk/ml/azure-ai-ml/azure/ai/ml/operations/_job_operations.py#L1495C12-L1495C12  # noqa: E501
        import jwt
        ...
        **kwargs,  # type: Any
        ...
        while status in [None, "InProgress"]:
            if time_run + sleep_period > timeout_seconds:
                message = (
                    f"Timeout for session {action} {session_id} for {AUTOMATIC_RUNTIME}.\n"
