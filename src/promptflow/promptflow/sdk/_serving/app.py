...
from promptflow.sdk._utils import update_environment_variables_with_connections
from promptflow.sdk.entities._flow import Flow
from promptflow.sdk.operations._run_submitter import variant_overwrite_context
...
class PromptflowServingApp(Flask):
    def init(self, **kwargs):
        with self.app_context():
            ...
            self.static_folder = static_folder if static_folder else self.project_path
    ...
    def init_executor_if_not_exist(self):
        ...
        coordinator = Flow._init_coordinator_from_env(environment_variables=self.environment_variables)
        ...
        logger.info("Promptflow serving runtime start getting connections from local...")
