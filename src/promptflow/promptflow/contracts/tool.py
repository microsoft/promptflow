...
class Tool:
    ...
    :param transition_from: A list of old tool IDs that are mapped to the current tool ID.
    :type transition_from: Optional[List[str]]
    """
    ...
    transition_from: Optional[List[str]] = None
