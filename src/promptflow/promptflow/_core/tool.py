...
class DynamicList:
    ...
    def __post_init__(self, function, input_mapping):
        ...
        # Dynamic list func inputs will not show in UI, so no need to add the ui_hinits:index
...
class GeneratedBy:
    ...
    def __post_init__(self, function, reverse_function, input_settings):
        ...
        # Generated by inputs will not show in UI, so no need to add the ui_hinits:index
