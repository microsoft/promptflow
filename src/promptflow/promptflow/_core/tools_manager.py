...
def set_input_index_to_ui_hints(tool):
    inputs_dict = tool["inputs"]
    input_index = 0
    for input_name, settings in inputs_dict.items():
        # Skip uionly_hidden input type because these inputs will be shown in a popup window
        # and its order is same with the generated by func parameters. No need the ui_hints: index
