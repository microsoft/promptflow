...
def retry(
    exception_to_check: Union[Type[Exception], Tuple[Type[Exception], ...]], tries=4, delay=3, backoff=2, logger=None
):
    """
...
def http_retry_wrapper(f, tries=4, delay=3, backoff=2, logger=None):
    """
