...
class FileHandler():
    ...
    def __init__(self, file_path: str, scrub_customer_content=False):
        ...
        self._formatter = CredentialScrubberFormatter(
            scrub_customer_content=scrub_customer_content,
            fmt=LOG_FORMAT,
            datefmt=DATETIME_FORMAT)
        self._stream_handler.setFormatter(self._formatter)

    def update_path(self, file_path: str):
        """Write log to another file path."""
        self._stream_handler = self._get_stream_handler(file_path)
        self._stream_handler.setFormatter(self._formatter)
