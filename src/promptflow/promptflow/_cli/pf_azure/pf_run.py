...
from promptflow._cli.pf_run import add_run_create, create_run
from promptflow._cli.utils import _set_workspace_argument_for_subparsers, get_client_for_cli
from promptflow.azure import PFClient
from promptflow.azure._restclient.flow_service_caller import FlowRequestException
from promptflow.sdk._constants import MAX_LIST_CLI_RESULTS, MAX_SHOW_DETAILS_RESULTS, Color, ListViewType
...
def dispatch_run_commands(args: argparse.Namespace):
    if args.sub_action == "create":
        ...
        create_run(
            create_func=functools.partial(pf.runs.create_or_update, runtime=args.runtime),
            file=args.file,
            flow=args.flow,
            data=args.data,
...
def visualize(
    ...
    try:
        ...
        print(Color.RED + error_message + Color.END)
