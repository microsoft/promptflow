...
REQUIRES = [
    "promptflow-tracing==1.18.3",  # tracing capabilities
    "promptflow-core==1.18.3",  # core capabilities
    "promptflow-devkit==1.18.3",  # devkit capabilities
]
...
setup(
    ...
    extras_require={
        "all": [
            "promptflow-core[executor-service]==1.18.3",
            "promptflow-devkit[all]==1.18.3",
            "promptflow-azure==1.18.3",
        ],
        "azure": ["promptflow-azure==1.18.3"],
        "executable": ["promptflow-devkit[executable]==1.18.3"],
        "azureml-serving": [
            "promptflow-core[azureml-serving]==1.18.3",
        ],
        "executor-service": [
            "promptflow-core[executor-service]==1.18.3",  # used to build web executor server
        ],
    },
