...
REQUIRES = [
    "promptflow-tracing==1.10.0rc11",  # tracing capabilities
    "promptflow-core==1.10.0rc11",  # core capabilities
    "promptflow-devkit==1.10.0rc11",  # devkit capabilities
]
...
setup(
    ...
    extras_require={
        "all": [
            "promptflow-core[executor-service]==1.10.0rc11",
            "promptflow-devkit[all]==1.10.0rc11",
            "promptflow-azure==1.10.0rc11",
        ],
        "azure": ["promptflow-azure==1.10.0rc11"],
        "executable": ["promptflow-devkit[executable]==1.10.0rc11"],
        "azureml-serving": [
            "promptflow-core[azureml-serving]==1.10.0rc11",
        ],
        "executor-service": [
            "promptflow-core[executor-service]==1.10.0rc11",  # used to build web executor server
        ],
    },
