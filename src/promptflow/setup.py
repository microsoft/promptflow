...
REQUIRES = [
    "promptflow-tracing==1.9.0rc9",  # tracing capabilities
    "promptflow-core==1.9.0rc9",  # core capabilities
    "promptflow-devkit==1.9.0rc9",  # devkit capabilities
]
...
setup(
    ...
    extras_require={
        "all": [
            "promptflow-core[executor-service]==1.9.0rc9",
            "promptflow-devkit[all]==1.9.0rc9",
            "promptflow-azure==1.9.0rc9",
        ],
        "azure": ["promptflow-azure==1.9.0rc9"],
        "executable": ["promptflow-devkit[executable]==1.9.0rc9"],
        "azureml-serving": [
            "promptflow-core[azureml-serving]==1.9.0rc9",
        ],
        "executor-service": [
            "promptflow-core[executor-service]==1.9.0rc9",  # used to build web executor server
        ],
    },
