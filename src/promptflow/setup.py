...
REQUIRES = [
    "promptflow-tracing==1.10.0rc1",  # tracing capabilities
    "promptflow-core==1.10.0rc1",  # core capabilities
    "promptflow-devkit==1.10.0rc1",  # devkit capabilities
]
...
setup(
    ...
    extras_require={
        "all": [
            "promptflow-core[executor-service]==1.10.0rc1",
            "promptflow-devkit[all]==1.10.0rc1",
            "promptflow-azure==1.10.0rc1",
        ],
        "azure": ["promptflow-azure==1.10.0rc1"],
        "executable": ["promptflow-devkit[executable]==1.10.0rc1"],
        "azureml-serving": [
            "promptflow-core[azureml-serving]==1.10.0rc1",
        ],
        "executor-service": [
            "promptflow-core[executor-service]==1.10.0rc1",  # used to build web executor server
        ],
    },
