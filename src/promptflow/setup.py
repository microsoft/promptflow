...
REQUIRES = [
    "promptflow-tracing==1.10.0rc8",  # tracing capabilities
    "promptflow-core==1.10.0rc8",  # core capabilities
    "promptflow-devkit==1.10.0rc8",  # devkit capabilities
]
...
setup(
    ...
    extras_require={
        "all": [
            "promptflow-core[executor-service]==1.10.0rc8",
            "promptflow-devkit[all]==1.10.0rc8",
            "promptflow-azure==1.10.0rc8",
        ],
        "azure": ["promptflow-azure==1.10.0rc8"],
        "executable": ["promptflow-devkit[executable]==1.10.0rc8"],
        "azureml-serving": [
            "promptflow-core[azureml-serving]==1.10.0rc8",
        ],
        "executor-service": [
            "promptflow-core[executor-service]==1.10.0rc8",  # used to build web executor server
        ],
    },
