...
REQUIRES = [
    "promptflow-tracing==1.1.0rc6",  # tracing capabilities
    "promptflow-core==1.1.0rc6",  # core capabilities
    "promptflow-devkit==1.8.0rc6",  # devkit capabilities
]
...
setup(
    ...
    extras_require={
        "all": [
            "promptflow-core[executor-service]==1.1.0rc6",
            "promptflow-devkit[all]==1.8.0rc6",
            "promptflow-azure==1.8.0rc6",
        ],
        "azure": ["promptflow-azure==1.8.0rc6"],
        "executable": ["promptflow-devkit[executable]==1.8.0rc6"],
        "azureml-serving": [
            "promptflow-core[azureml-serving]==1.1.0rc6",
        ],
        "executor-service": [
            "promptflow-core[executor-service]==1.1.0rc6",  # used to build web executor server
        ],
    },
