...
REQUIRES = [
    "promptflow-tracing==1.18.4",  # tracing capabilities
    "promptflow-core==1.18.4",  # core capabilities
    "promptflow-devkit==1.18.4",  # devkit capabilities
]
...
setup(
    ...
    extras_require={
        "all": [
            "promptflow-core[executor-service]==1.18.4",
            "promptflow-devkit[all]==1.18.4",
            "promptflow-azure==1.18.4",
        ],
        "azure": ["promptflow-azure==1.18.4"],
        "executable": ["promptflow-devkit[executable]==1.18.4"],
        "azureml-serving": [
            "promptflow-core[azureml-serving]==1.18.4",
        ],
        "executor-service": [
            "promptflow-core[executor-service]==1.18.4",  # used to build web executor server
        ],
    },
