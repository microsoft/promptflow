...
REQUIRES = [
    "promptflow-tracing==1.1.0rc3",  # tracing capabilities
    "promptflow-core==1.1.0rc3",  # core capabilities
    "promptflow-devkit==1.8.0rc3",  # devkit capabilities
]
...
setup(
    ...
    extras_require={
        "all": [
            "promptflow-core[executor-service]==1.1.0rc3",
            "promptflow-devkit[all]==1.8.0rc3",
            "promptflow-azure==1.8.0rc3",
        ],
        "azure": ["promptflow-azure==1.8.0rc3"],
        "executable": ["promptflow-devkit[executable]==1.8.0rc3"],
        "azureml-serving": [
            "promptflow-core[azureml-serving]==1.1.0rc3",
        ],
        "executor-service": [
            "promptflow-core[executor-service]==1.1.0rc3",  # used to build web executor server
        ],
    },
