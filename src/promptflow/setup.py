...
REQUIRES = [
    "promptflow-tracing==1.9.0rc5",  # tracing capabilities
    "promptflow-core==1.9.0rc5",  # core capabilities
    "promptflow-devkit==1.9.0rc5",  # devkit capabilities
]
...
setup(
    ...
    extras_require={
        "all": [
            "promptflow-core[executor-service]==1.9.0rc5",
            "promptflow-devkit[all]==1.9.0rc5",
            "promptflow-azure==1.9.0rc5",
        ],
        "azure": ["promptflow-azure==1.9.0rc5"],
        "executable": ["promptflow-devkit[executable]==1.9.0rc5"],
        "azureml-serving": [
            "promptflow-core[azureml-serving]==1.9.0rc5",
        ],
        "executor-service": [
            "promptflow-core[executor-service]==1.9.0rc5",  # used to build web executor server
        ],
    },
