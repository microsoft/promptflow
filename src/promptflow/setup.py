...
REQUIRES = [
    ...
    "promptflow-core==1.1.0rc5",  # core capabilities
    "promptflow-devkit==1.0.0rc7",  # devkit capabilities
]
...
setup(
    ...
    extras_require={
        "all": [
            "promptflow-core[executor-service]==1.1.0rc5",
            "promptflow-devkit[all]==1.0.0rc7",
            "promptflow-azure==1.0.0rc7",
        ],
        "azure": ["promptflow-azure==1.0.0rc7"],
        "executable": ["promptflow-devkit[executable]==1.0.0rc7"],
        "azureml-serving": [
            "promptflow-core[azureml-serving]==1.1.0rc5",
        ],
        "executor-service": [
            "promptflow-core[executor-service]==1.1.0rc5",  # used to build web executor server
        ],
    },
