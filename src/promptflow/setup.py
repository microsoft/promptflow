...
REQUIRES = [
    "promptflow-tracing==1.18.1",  # tracing capabilities
    "promptflow-core==1.18.1",  # core capabilities
    "promptflow-devkit==1.18.1",  # devkit capabilities
]
...
setup(
    ...
    extras_require={
        "all": [
            "promptflow-core[executor-service]==1.18.1",
            "promptflow-devkit[all]==1.18.1",
            "promptflow-azure==1.18.1",
        ],
        "azure": ["promptflow-azure==1.18.1"],
        "executable": ["promptflow-devkit[executable]==1.18.1"],
        "azureml-serving": [
            "promptflow-core[azureml-serving]==1.18.1",
        ],
        "executor-service": [
            "promptflow-core[executor-service]==1.18.1",  # used to build web executor server
        ],
    },
