...
REQUIRES = [
    "promptflow-tracing==1.1.0rc5",  # tracing capabilities
    "promptflow-core==1.1.0rc5",  # core capabilities
    "promptflow-devkit==1.8.0rc5",  # devkit capabilities
]
...
setup(
    ...
    extras_require={
        "all": [
            ...
            "promptflow-devkit[all]==1.8.0rc5",
            "promptflow-azure==1.8.0rc5",
        ],
        "azure": ["promptflow-azure==1.8.0rc5"],
        "executable": ["promptflow-devkit[executable]==1.8.0rc5"],
        "azureml-serving": [
