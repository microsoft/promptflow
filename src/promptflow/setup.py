...
REQUIRES = [
    "promptflow-tracing==1.9.0rc7",  # tracing capabilities
    "promptflow-core==1.9.0rc7",  # core capabilities
    "promptflow-devkit==1.9.0rc7",  # devkit capabilities
]
...
setup(
    ...
    extras_require={
        "all": [
            "promptflow-core[executor-service]==1.9.0rc7",
            "promptflow-devkit[all]==1.9.0rc7",
            "promptflow-azure==1.9.0rc7",
        ],
        "azure": ["promptflow-azure==1.9.0rc7"],
        "executable": ["promptflow-devkit[executable]==1.9.0rc7"],
        "azureml-serving": [
            "promptflow-core[azureml-serving]==1.9.0rc7",
        ],
        "executor-service": [
            "promptflow-core[executor-service]==1.9.0rc7",  # used to build web executor server
        ],
    },
