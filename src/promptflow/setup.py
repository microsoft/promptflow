...
REQUIRES = [
    "promptflow-tracing==1.14.0",  # tracing capabilities
    "promptflow-core==1.14.0",  # core capabilities
    "promptflow-devkit==1.14.0",  # devkit capabilities
]
...
setup(
    ...
    extras_require={
        "all": [
            "promptflow-core[executor-service]==1.14.0",
            "promptflow-devkit[all]==1.14.0",
            "promptflow-azure==1.14.0",
        ],
        "azure": ["promptflow-azure==1.14.0"],
        "executable": ["promptflow-devkit[executable]==1.14.0"],
        "azureml-serving": [
            "promptflow-core[azureml-serving]==1.14.0",
        ],
        "executor-service": [
            "promptflow-core[executor-service]==1.14.0",  # used to build web executor server
        ],
    },
