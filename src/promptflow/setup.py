...
REQUIRES = [
    "promptflow-tracing==1.18.5",  # tracing capabilities
    "promptflow-core==1.18.5",  # core capabilities
    "promptflow-devkit==1.18.5",  # devkit capabilities
]
...
setup(
    ...
    extras_require={
        "all": [
            "promptflow-core[executor-service]==1.18.5",
            "promptflow-devkit[all]==1.18.5",
            "promptflow-azure==1.18.5",
        ],
        "azure": ["promptflow-azure==1.18.5"],
        "executable": ["promptflow-devkit[executable]==1.18.5"],
        "azureml-serving": [
            "promptflow-core[azureml-serving]==1.18.5",
        ],
        "executor-service": [
            "promptflow-core[executor-service]==1.18.5",  # used to build web executor server
        ],
    },
