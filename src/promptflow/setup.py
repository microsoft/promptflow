...
REQUIRES = [
    "promptflow-tracing==1.15.0.post1",  # tracing capabilities
    "promptflow-core==1.15.0.post1",  # core capabilities
    "promptflow-devkit==1.15.0.post1",  # devkit capabilities
]
...
setup(
    ...
    extras_require={
        "all": [
            "promptflow-core[executor-service]==1.15.0.post1",
            "promptflow-devkit[all]==1.15.0.post1",
            "promptflow-azure==1.15.0.post1",
        ],
        "azure": ["promptflow-azure==1.15.0.post1"],
        "executable": ["promptflow-devkit[executable]==1.15.0.post1"],
        "azureml-serving": [
            "promptflow-core[azureml-serving]==1.15.0.post1",
        ],
        "executor-service": [
            "promptflow-core[executor-service]==1.15.0.post1",  # used to build web executor server
        ],
    },
