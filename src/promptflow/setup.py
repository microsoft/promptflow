...
REQUIRES = [
    "promptflow-tracing==1.11.0rc4",  # tracing capabilities
    "promptflow-core==1.11.0rc4",  # core capabilities
    "promptflow-devkit==1.11.0rc4",  # devkit capabilities
]
...
setup(
    ...
    extras_require={
        "all": [
            "promptflow-core[executor-service]==1.11.0rc4",
            "promptflow-devkit[all]==1.11.0rc4",
            "promptflow-azure==1.11.0rc4",
        ],
        "azure": ["promptflow-azure==1.11.0rc4"],
        "executable": ["promptflow-devkit[executable]==1.11.0rc4"],
        "azureml-serving": [
            "promptflow-core[azureml-serving]==1.11.0rc4",
        ],
        "executor-service": [
            "promptflow-core[executor-service]==1.11.0rc4",  # used to build web executor server
        ],
    },
