...
REQUIRES = [
    "promptflow-tracing==1.10.0rc10",  # tracing capabilities
    "promptflow-core==1.10.0rc10",  # core capabilities
    "promptflow-devkit==1.10.0rc10",  # devkit capabilities
]
...
setup(
    ...
    extras_require={
        "all": [
            "promptflow-core[executor-service]==1.10.0rc10",
            "promptflow-devkit[all]==1.10.0rc10",
            "promptflow-azure==1.10.0rc10",
        ],
        "azure": ["promptflow-azure==1.10.0rc10"],
        "executable": ["promptflow-devkit[executable]==1.10.0rc10"],
        "azureml-serving": [
            "promptflow-core[azureml-serving]==1.10.0rc10",
        ],
        "executor-service": [
            "promptflow-core[executor-service]==1.10.0rc10",  # used to build web executor server
        ],
    },
