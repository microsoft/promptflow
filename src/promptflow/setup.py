...
REQUIRES = [
    "promptflow-tracing==1.10.0rc2",  # tracing capabilities
    "promptflow-core==1.10.0rc2",  # core capabilities
    "promptflow-devkit==1.10.0rc2",  # devkit capabilities
]
...
setup(
    ...
    extras_require={
        "all": [
            "promptflow-core[executor-service]==1.10.0rc2",
            "promptflow-devkit[all]==1.10.0rc2",
            "promptflow-azure==1.10.0rc2",
        ],
        "azure": ["promptflow-azure==1.10.0rc2"],
        "executable": ["promptflow-devkit[executable]==1.10.0rc2"],
        "azureml-serving": [
            "promptflow-core[azureml-serving]==1.10.0rc2",
        ],
        "executor-service": [
            "promptflow-core[executor-service]==1.10.0rc2",  # used to build web executor server
        ],
    },
