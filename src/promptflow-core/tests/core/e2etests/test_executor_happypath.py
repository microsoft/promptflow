...
from promptflow.executor._errors import InputTypeError
...
from ...utils import FLOW_ROOT, get_flow_folder, get_flow_sample_input, get_yaml_file, is_image_file
...
class TestExecutor:
    ...
    def test_executor_exec_line(self, flow_folder, dev_connections):
        ...
        flow_result = executor.exec_line(get_flow_sample_input(flow_folder))
    ...
    def test_long_running_log(self, dev_connections, capsys):
        ...
        executor = FlowExecutor.create(get_yaml_file(flow_folder), dev_connections)
        executor.exec_line(get_flow_sample_input(flow_folder))
    ...
    #     inputs = get_flow_inputs(SAMPLE_FLOW)
