...
from promptflow._sdk._utility.tracing_utils import WorkspaceKindLocalCache, append_conditions, parse_protobuf_span
...
class TestWorkspaceKindLocalCache:
    def test_no_cache(self):
        ...
        with patch(
            "promptflow._sdk._utility.tracing_utils.WorkspaceKindLocalCache._get_workspace_kind_from_azure"
        ) as mock_get_kind:
