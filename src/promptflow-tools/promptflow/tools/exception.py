...
class WrappedOpenAIError(UserErrorException):
    ...
    def error_codes(self):
        ...
        By default, the error code hierarchy is generated by the base class `PromptflowException`.
        However, for `OpenAIError` , it is from OpenAI python library, rather than from  promptflow.
        So we override its error codes in alignment with above convention.
        """
