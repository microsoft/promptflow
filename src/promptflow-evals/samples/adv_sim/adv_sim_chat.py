...
async def main(azure_ai_project):
    ...
    try:
        result = await evaluate_chat(
            azure_ai_project, datafile=upia_output_file, eval_name="upia_chat_large_eval_Spanish"
        )
    ...
    try:
        result = await evaluate_chat(
            azure_ai_project, datafile=regular_output_file, eval_name="regular_chat_large_eval_Spanish"
        )
        print(json.dumps(result, indent=2))
    except Exception as e:
        print(e)
