...
class TestEvalRun:
    ...
    def test_end_raises(self, setup_data, status, should_raise, caplog):
    ...
    def test_run_logs_if_terminated(self, setup_data, caplog):
    ...
    def test_singleton(self, mock_session_cls, setup_data, destroy_run, runs_are_the_same):
