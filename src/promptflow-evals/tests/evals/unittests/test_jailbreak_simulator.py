...
from promptflow.evals.synthetic import AdversarialScenario, UPIAJailbreakAdversarialSimulator
...
class TestSimulator:
    ...
    def test_initialization_with_all_valid_scenarios(
        ...
        for scenario in available_scenarios:
            simulator = UPIAJailbreakAdversarialSimulator(azure_ai_project=azure_ai_project)
