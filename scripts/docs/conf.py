...
linkcheck_ignore = [
    ...
    "https://github.com/microsoft/promptflow/tree/main/examples/flex-flows",  # remove when sample PR merged
    "https://github.com/microsoft/promptflow/tree/main/examples/tutorials/tracing",  # remove when sample PR merged
]
