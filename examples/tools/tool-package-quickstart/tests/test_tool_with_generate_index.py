...
def test_my_tool():
    ...
    index_json = generate_index_json(index_type=index_type, index=index, content_field=content_field, embedding_deployment=embedding_deployment)
...
def test_generate_index_json():
    ...
    embedding_deployment=list_embedding_deployment(index_type)[1]
    kwargs = {"a":"b", "c":"d"}
    index_json = generate_index_json(index_type=index_type, index=index, content_field=content_field, embedding_deployment=embedding_deployment, **kwargs)
