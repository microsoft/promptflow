from promptflow._core.tool import InputSettings, DynamicList, tool
...
dynamic_list_setting = DynamicList(function=my_list_func, input_mapping={"prefix": "input_text"})
input_settings = {
