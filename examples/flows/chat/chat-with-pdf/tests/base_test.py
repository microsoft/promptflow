...
class BaseTest(unittest.TestCase):
    def setUp(self):
        ...
        self.data_path = os.path.join(self.flow_path, "test_data/bert-paper-qna-1-line.jsonl")
        self.eval_groundedness_flow_path = os.path.join(root, "eval_groundedness")
        self.eval_perceived_intelligence_flow_path = os.path.join(root, "eval_perceived_intelligence")
    ...
    def create_eval_run(self, eval_flow_path, base_run, column_mapping, connections=None, runtime=None):
