...
``` bash
# create run
pfazure run create --flow . --data ./data.jsonl --column-mapping url='${data.url}' --stream --runtime tmp-example-runtime-ci --subscription <your_subscription_id> -g <your_resource_group_name> -w <your_workspace_name>
...
pfazure run create --file run.yml --runtime tmp-example-runtime-ci --stream
