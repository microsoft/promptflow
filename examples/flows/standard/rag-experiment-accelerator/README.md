...
2. From the `examples/flows/standard/rag-experiment-accelerator` directoy, run: `pip install ./custom_environment/rag_experiment_accelerator-0.9-py3-none-any.whl` 
