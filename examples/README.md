...
| [custom_llm_tool_showcase](flows/standard/custom_llm_tool_showcase/README.md) | [![samples_flows_standard_custom_llm_tool_showcase](https://github.com/microsoft/promptflow/actions/workflows/samples_flows_standard_custom_llm_tool_showcase.yml/badge.svg?branch=main)](https://github.com/microsoft/promptflow/actions/workflows/samples_flows_standard_custom_llm_tool_showcase.yml) |  A standard flow using `custom_llm` tool |
