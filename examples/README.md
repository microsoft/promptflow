...
| path | status | description |
------|--------|-------------
| [auto_generate_docstring](flows/standard/auto_generate_docstring/README.md) | [![samples_flows_standard_auto_generate_docstring](https://github.com/microsoft/promptflow/actions/workflows/samples_flows_standard_auto_generate_docstring.yml/badge.svg?branch=main)](https://github.com/microsoft/promptflow/actions/workflows/samples_flows_standard_auto_generate_docstring.yml) |  This example can help you automatically generate Python code's docstring and return the modified code |
