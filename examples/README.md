...
| [basic-with-embedding-tool](flows/standard/basic-with-embedding-tool/README.md) | [![samples_flows_standard_basic_with_embedding_tool](https://github.com/microsoft/promptflow/actions/workflows/samples_flows_standard_basic_with_embedding_tool.yml/badge.svg?branch=main)](https://github.com/microsoft/promptflow/actions/workflows/samples_flows_standard_basic_with_embedding_tool.yml) |  A basic standard flow using an Azure OpenAI connection and the builtin embedding tool to generate embeddings for input text |
