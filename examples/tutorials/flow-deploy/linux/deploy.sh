...
location="centralus"
sku="F1"
name="basic-with-connection8c78f9"
verbose=false
...
echo "$command"
eval "$command"
echo "Please go to https://ms.portal.azure.com/ to config environment variables for the app: $name at (Settings>Configuration) or (Settings>Environment variables)"
