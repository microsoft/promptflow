...
![init_flow_folder](../../media/community/local/init-and-test-a-flow/flow_folder.png)
...
![init_output](../../media/community/local/init-and-test-a-flow/flow_init_output.png)
...
![init_files](../../media/community/local/init-and-test-a-flow/flow_init_files.png)
## Test a flow locally
...
![flow test](../../media/community/local/init-and-test-a-flow/flow_test.png)
...
![flow_output_files](../../media/community/local/init-and-test-a-flow/flow_output_files.png)
...
![chat](../../media/community/local/init-and-test-a-flow/chat.png)
