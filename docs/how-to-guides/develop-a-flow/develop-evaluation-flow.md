...
- `groundtruth`: This input is essential for passing the data through the evaluation flow. It represents the actual or expected values against which the performance of the standard/chat flow will be evaluated.
