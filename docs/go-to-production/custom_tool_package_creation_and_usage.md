...
![tool folder structure](../media/custom_tool_package/tool-folder-structure.png)
...
5. **hello_world/yamls/hello_world_tool.yaml**: Tool YAMLs defines the metadata of the tool. The tool list method, as outlined in the `utils.py`, fetches these tool YAMLs.
    ...
    > [!Note]
    > If you create a new tool, don't forget to also create the corresponding tool YAML. you can use below command under your tool project to auto generate your tool YAML.
...
1. Create a customized environment with docker context.
   ...
   Currently we support creating environment with "Create a new docker context" environment source. "Use existing docker image with optional conda file" has known [limitation](https://learn.microsoft.com/en-us/azure/machine-learning/how-to-manage-environments-v2?view=azureml-api-2&tabs=cli#create-an-environment-from-a-conda-specification) and is not supported now.
    ...
    ![create aml env](../media/custom_tool_package/create_customized_env_step1.png)
   ...
   ```
    ...
    ![define docker](../media/custom_tool_package/create_customized_env_step2.png)
...
3. Create runtime with CI using the customized environment created in step 2.
   ...
   3.2 Create runtime on CI with customized environment.
    ![CreateRuntimeOnCI](../media/custom_tool_package/create_runtime_on_CI.png)
...
4. Create runtime with MIR using the customized environment created in step 2. Please refer to [this guidance](how-to-create-manage-runtime.md) for the details how to create a runtime with MIR.
    ![CreateRuntimeOnMIR](../media/custom_tool_package/create_runtime_on_mir.png)
...
Step2: Select the correct runtime ("my-tool-runtime") and add your tools.![AddTool](../media/custom_tool_package/test_customer_tool_on_UI_step1.png)

Step3: Change flow based on your requirements and run flow in the selected runtime.![Runflow](../media/custom_tool_package/test_customer_tool_on_UI_step2.png)
...
![install-vsix](../media/custom_tool_package/install-vsix.png)
...
![auto-list-tool-in-extension](../media/custom_tool_package/auto-list-tool-in-extension.png)
