...
| `column_mapping`        | object        | Inputs column mapping, use `${data.xx}` to refer to data file columns, use `${run.inputs.xx}` to refer to referenced run's data file columns, and `${run.outputs.xx}` to refer to run outputs columns.columns.                                                                                                                 |
