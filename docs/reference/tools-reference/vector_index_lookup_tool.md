...
```
  ...
  > [!NOTE]
  > when legacy tools switching to code first mode, "not found" error may occur, please refer to [tool rename reminder](faq.md#vectordbfaiss-indexvector-index-lookup-tool-rename-reminders).